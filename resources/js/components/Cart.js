...
//         this.handleScanCategory = this.handleScanCategory.bind(this);
...
//     handleScanCategory(event) {
//         event.preventDefault();
//         const { category } = this.state;
//         if (!!category) {
//             axios
//                 .post("/admin/cart", { category })
//                 .then(res => {
//                     this.loadCart();
//                     this.setState({ category: "" });
//                 })
...
//     addProductToCart(category) {
//         let product = this.state.products.find(p => p.category === category);
//         if (!!product) {
...
//     }
//     render() {
//         const { cart, products, customers, category } = this.state;
//         return (
//             <div className="row">
//                 <div className="col-md-6 col-lg-4">
//                     <div className="row mb-2">
//                         <div className="col">
//                             <form onSubmit={this.handleScanCategory}>
//                                 <input
//                                     type="text"
...
//                         {products.map(p => (
//                             <div
//                                 onClick={() => this.addProductToCart(p.category)}
//                                 key={p.id}
//                                 className="item"
//                             >
