            ...
            <table>
                ...
                @foreach ($cartData as $item)
                    <tr class="service">
                        ...
                        <td class="tableitem"><p class="itemtext">{{ config('settings.currency_symbol') }}{{ $item['price'] }}</p></td>
                    </tr>
                @endforeach
                ...
                <tr class="tabletitle">
                    ...
                    <td class="payment"><h2>{{ config('settings.currency_symbol') }}{{ $amount }}</h2></td>
                    <p class="itemtext">Status: {{$status}}</p>
                </tr>

                <!-- <tr class="tabletitle">
                    <td></td>
                    <td class="Rate"><h2>Payment Methods:</h2></td>
                    <td class="payment"><h2>{{ implode(', ', $paymentMethods) }}</h2></td>
                </tr> -->
            </table>
        </div><!--End Table-->
